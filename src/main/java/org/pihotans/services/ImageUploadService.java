package org.pihotans.services;

import org.pihotans.entity.ImageModel;
import org.pihotans.entity.Post;
import org.pihotans.entity.User;
import org.pihotans.exceptions.ImageNotFoundException;
import org.pihotans.repository.ImageRepository;
import org.pihotans.repository.PostRepository;
import org.pihotans.repository.UserRepository;
...
public class ImageUploadService {
    ...
    public ImageModel uploadImageToPost(MultipartFile file, Principal principal, Long postId) throws IOException {
        ...
        Post post = user.getPosts()
                .stream()
                .filter(thisPost -> thisPost.getId().equals(postId))
